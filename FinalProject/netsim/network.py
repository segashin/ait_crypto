...
def read_msg(src): 
	# checks if there is any new file in OUT dir of given src(ABC...)
	# called in the main loop for each src
...
def write_msg(dst, msg): 
	# creates a file under IN dir of given dst(ABC)
	# called in the main loop when read_msg detected any new file to be sent
